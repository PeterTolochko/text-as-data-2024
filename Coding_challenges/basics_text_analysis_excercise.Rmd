...
articles_en$headline[2]
 paste(articles_en$headline[1], articles_en$headline[2], sep='___')
 
 articles_en$full_article <- paste(articles_en$headline, articles_en$source)
...
```{r}
grep('asyl', articles_en$headline)
```
...
- Create a word cloud with all features that occure at least 10 times.
