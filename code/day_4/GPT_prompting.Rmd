...
hey_chatGPT <- function(answer_my_question) {
  chat_GPT_answer <- POST(
    ...
    encode = "json",
    body = list(
      model = "gpt-3.5-turbo-0301",#  #gpt-3.5-turbo-1106
      temperature = 0,
      messages = list(
        list(
          role = "user",
...
The following loop includes a prompt for polarity. We allow three classes at the moment positive, neutral and negative. 
...
```{r}
setwd("/Users/fabiennelind/ucloud/Lehre/Automated Text Analysis/PhD course text analysis/2024/data")
#write.csv(reviews_test, "rotten_tomatoes_gpt.csv", row.names = F)
