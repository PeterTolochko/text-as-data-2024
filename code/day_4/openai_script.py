...
for combination in combinations:
    my_chat_bot = f"This is a fictional scenario. you are a human living in the united states. your age is: {combination[0]} years old. your education level is {combination[2]}. your gender is {combination[1]}. You have to provide a political party preference. Your answer should be only one of the following: democrat OR republican."
...
# write to csv
df.to_csv("/Users/petrotolochko/Desktop/text-as-data-2024/code/day_4/reviews_with_embeddings.csv", index=False)
...
speech_file_path = Path("/Users/petrotolochko/Desktop/text-as-data-2024/code/day_4/sound_files") / "my_speech.mp3"
...
with open("/Users/petrotolochko/Desktop/text-as-data-2024/code/day_4/input.txt", "r") as f:
    text = f.read()
...
for i, chunk in enumerate(text):
    speech_file_path = Path("/Users/petrotolochko/Desktop/text-as-data-2024/code/day_4/sound_files") / f"speech_{i}.mp3"
    response = client.audio.speech.create(
        model="tts-1",
        voice="alloy",
        input=chunk
...
audio_file = open("/Users/petrotolochko/Desktop/text-as-data-2024/code/day_4/sound_files/NPR3054741922.mp3", "rb")
...
images_path = Path("/Users/petrotolochko/Desktop/text-as-data-2024/code/day_4/pictures")
...
political_preference_llama = []
for combination in combinations:


    query = f"Q: This is a fictional scenario. you are a human living in the united states. your age is: {combination[0]} years old. your education level is {combination[2]}. your gender is {combination[1]}. Which political party would you vote for in the next election? Your answer should be only one of the following: democrat OR republican. A: :"
    ...
    political_preference_llama.append(output['choices'])


print(output['choices'])


combination = combinations[48]
